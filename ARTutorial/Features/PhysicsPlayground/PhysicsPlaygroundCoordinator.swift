...
final class PhysicsPlaygroundCoordinator {
    ...
    private func placePlayground(at location: CGPoint, in arView: ARView) {
        ...
        // Enable physics simulation for the playground's bodies. On this RealityKit
        // version a PhysicsBodyComponent alone doesn't simulate — an ancestor needs a
        // PhysicsSimulationComponent. Put it on the anchor (parent of all bodies), not
        // on a body itself, or simulation breaks.
